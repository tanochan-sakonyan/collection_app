      ...
      body: SingleChildScrollView(
        child: Center(
          child: Padding(
            ...
            children: [
              const TextSpan(text: "このプライバシーポリシーは、Yuma Ikeo（以下「サービス提供者」）が提供する集金くんアプリ（以下「アプリ」）に適用されます。このアプリは無料サービスとして提供されています。今後のアップデートに伴い、一部有料課金制の機能が追加される可能性がございます。\n\n【情報の収集と利用】\nアプリは、あなたがアプリをダウンロードして使用する際に情報を収集します。この情報には以下が含まれる場合があります： あなたのデバイスのインターネットプロトコルアドレス（例：IPアドレス） アプリ内で訪れたページ、訪問の日時、ページに費やした時間 アプリの使用時間 モバイルデバイスで使用しているオペレーティングシステム アプリは、あなたのモバイルデバイスの正確な位置情報を収集しません。 サービス提供者は、提供された情報を使用して、重要な情報、必要な通知、マーケティングプロモーションなどを提供するために、随時あなたに連絡することがあります。 より良い体験を提供するために、アプリを使用中、サービス提供者はあなたに特定の個人情報を提供するようお願いすることがあります。 これには、LINEのユーザーID、LINEのユーザー名、その他LINEログインによって収集される情報などが含まれる場合があります。サービス提供者が要求する情報は、彼らによって保持され、このプライバシーポリシーに記載された通りに使用されます。\n\n【第三者アクセス】\n集計された匿名データのみが定期的に外部サービスに送信され、サービス提供者がアプリおよびサービスの改善に役立てます。サービス提供者は、このプライバシーポリシーに記載された方法であなたの情報を第三者と共有することがあります。 サービス提供者は、以下の場合にユーザーが提供した情報や自動的に収集された情報を開示することがあります：\n・法律に基づいて必要な場合、例えば召喚状や類似の法的手続きを遵守するため。\n・自身の権利を守るため、あなたや他の人の安全を守るため、詐欺調査のため、または政府の要求に応じるために開示が必要であると正当な理由で信じる場合。\n・サービス提供者の代理として働き、開示された情報を独立して使用せず、このプライバシーポリシーのルールに従うことに同意した信頼できるサービスプロバイダーと協働する場合。\n\n【オプトアウトの権利】\nアプリをアンインストールすることで、アプリによる情報収集をすべて停止することができます。モバイルデバイスの標準的なアンインストール手順や、アプリケーションマーケットプレイスまたはネットワークを通じてアンインストールを行うことができます。\n\n【データ保持ポリシー】\nサービス提供者は、ユーザー提供のデータを、アプリを使用している間およびその後の合理的な期間保持します。アプリを通じて提供したユーザーデータの削除を希望する場合は、"),
              WidgetSpan(
